...
//lpm_add_sub DEVICE_FAMILY="Stratix II" LPM_DIRECTION="ADD" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTH=10 ONE_INPUT_IS_CONSTANT="NO" dataa datab result
...
`endif
	...
	assign
		result = dataa + datab;
endmodule //lpm_add_sub1_add_sub
//VALID FILE
...
module lpm_add_sub1 (
	...
	lpm_add_sub1_add_sub	lpm_add_sub1_add_sub_component (
				.dataa (dataa),
				.datab (datab),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_add_sub1.tdf TRUE
...
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_add_sub1_inst.tdf TRUE
...
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_add_sub1_syn.v TRUE
