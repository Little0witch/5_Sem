...
//lpm_mux DEVICE_FAMILY="Stratix II" LPM_SIZE=2 LPM_WIDTH=8 LPM_WIDTHS=1 data result sel
...
module lpm_mux3 (
	...
	lpm_mux3_mux	lpm_mux3_mux_component (
				.sel (sub_wire2),
				.data (sub_wire4),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_mux3.tdf TRUE
...
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_mux3_inst.tdf TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_mux3_syn.v TRUE
